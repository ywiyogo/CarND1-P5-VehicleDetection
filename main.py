...
def main():
    ...
    global veh_finder
    veh_finder = VehicleFinder(track=True, threshold=2)
    veh_finder.init_detection_algorithm("HOG")

    #ffmpeg_extract_subclip("project_video.mp4", 0, 4, targetname="test3.mp4")
    if 1:
        # vidfilename = "test1.mp4"
        # write_output = "test1_result-t2-track.mp4"
        vidfilename = "project_video.mp4"
        write_output = "project_video_result-t2-track.mp4"
